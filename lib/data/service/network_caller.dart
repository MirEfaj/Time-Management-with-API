...
class NetworkCaller {
  ...
  static const String _unAuthrizeMessage = 'Un-Authrize Token';
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return NetworkResponse(
          isSuccess: false,
          statusCode: response.statusCode,
          errorMessage:  _unAuthrizeMessage,
        );
      }  else {
        final decodedJson = jsonDecode(response.body);
        return NetworkResponse(
  ...
  static  Future<void> unAuthurize() async{
      await AuthController.clearData();
      Navigator.pushNamedAndRemoveUntil(TimeManagement.navigator.currentContext!, SignInScreen.name, (predicate)=>false);
  }
}